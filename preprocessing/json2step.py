...
def process_one_file(json_path, output_dir):
    ...
    model.export_model(os.path.join(output_dir, f"./{file_name}.step"))

    os.makedirs(output_dir, exist_ok=True)
    for i in range(len(model.seq)):
        model_sub = model.submodel(i)
        model_sub.export_model(os.path.join(output_dir, f"{file_name}_{i:05d}.step"))
...
def main():
    ...
    parser.add_argument('--chunk', type=int, default=0, help="Chunk value, default is 0")
    parser.add_argument('--input_dir', type=str, default="/public/home/qidacheng/workspace/cad/dataset/cadv2-json", help="Input directory path")
    parser.add_argument('--output_dir', type=str, default="/public/home/qidacheng/workspace/cad/dataset/cadv2-step", help="Output directory path")
...
if __name__ == "__main__":
    # main()
    process_one_file("/mnt/afs/wangchenyu/dataset/cadv2/0067/00675619/json/00675619_00004.json", "./")
